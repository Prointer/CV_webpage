...
export function IconAPIv2(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill="currentColor" d="M13.26 10.5h2v1h-2z"></path>
      <path
        fill="currentColor"
      ...
      ></path>
      <path fill="currentColor" d="M6.43 12.77h1.16l-.58-1.59z"></path>
    </svg>
  )
}
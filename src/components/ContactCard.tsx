...
export interface ContactCardProps {
	...
	mode: 'auto' | 'fill'
	minHeightMobile?: number // px
	minHeightDesktop?: number // px
}
	...
	return (
		...
		>
			<motion.div
				...
				className='relative w-full will-change-transform cursor-pointer min-h-[150px] md:min-h-[150px] [transform:translateZ(0)]'
				style={{
			...
			>
				...
				>
					...
					<div className='mt-5 md:mt-0 flex justify-center gap-4 text-2xl'>
						{socialLinks.map(s => (
							<a
								key={s.label}
								href={s.url}

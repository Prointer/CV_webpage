...
// 	{ name: 't{header.hero}', targetId: 'hero' },
// 	{ name: 't{header.skills}', targetId: 'skills' },
// 	{ name: 't{header.portfolio}', targetId: 'portfolio' },
// 	{ name: 't{header.contact}', targetId: 'footer' },
// ]
...
const NAV_LINKS: ReadonlyArray<navLink> = [
	{ i18nKey: 'header.nav.about', targetId: 'hero' },
	{ i18nKey: 'header.nav.skills', targetId: 'skills' },
	{ i18nKey: 'header.nav.portfolio', targetId: 'portfolio' },
	{ i18nKey: 'header.nav.contact', targetId: 'footer' },
]
...
const Header: React.FC<HeaderProps> = ({ toggleModal }) => {
	...
	return (
		<header
			ref={headerRef}
			className='fixed top-0 left-0 right-0 w-full text-white shadow-lg z-50 border-b border-white/10 bg-black/40 backdrop-blur-md transition-all duration-300'
		>
			<div className='max-w-6xl mx-auto px-2 py-2 flex items-center justify-between relative'>
				...
				<div className='hidden md:flex items-center gap-4'>
					...
					<button
						type='button'
						onClick={toggleModal}
						className='relative px-4 py-2 text-sm font-bold text-sky-400 border-2 border-dashed border-sky-400 hover:bg-sky-400/10 transition-all duration-300'
					>
						...
						<svg
							...
							height='6'
							viewBox='0 0 5 5'
							className='absolute -top-1 -left-1 fill-sky-400'
						>
						...
						<svg
							...
							height='6'
							viewBox='0 0 5 5'
							className='absolute -top-1 -right-1 fill-sky-400'
						>
							<path d='M2 0h1v2h2v1h-2v2h-1v-2h-2v-1h2z' />
						</svg>
						<svg
							...
							height='6'
							viewBox='0 0 5 5'
							className='absolute -bottom-1 -left-1 fill-sky-400'
						>
							<path d='M2 0h1v2h2v1h-2v2h-1v-2h-2v-1h2z' />
						</svg>
						<svg
							...
							height='6'
							viewBox='0 0 5 5'
							className='absolute -bottom-1 -right-1 fill-sky-400'
						>
							<path d='M2 0h1v2h2v1h-2v2h-1v-2h-2v-1h2z' />
						</svg>
					</button>

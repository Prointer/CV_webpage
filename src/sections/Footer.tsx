...
const Footer: React.FC = () => {
  ...
  const SocialLinks = [
    ...
    { icon: <FaLinkedin />, url: "https://www.linkedin.com/in/vladyslav-omelianenko/", label: "LinkedIn" },
    { icon: <FaFacebook />, url: "https://www.facebook.com/vlad.omelianenko/", label: "Facebook" },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-10 items-stretch">
          ...
          <div className="md:col-span-3 flex flex-col">
            <h3 className="text-2xl sm:text-3xl font-bold leading-tight">
              ...
              <span className="text-brand">any project</span>.
            </h3>

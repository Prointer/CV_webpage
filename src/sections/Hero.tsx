	...
	return (
		<>
          ...
          '
			...
			<StatsSection
				items={[
					{ label: t('hero.statsSection.experience'), value: 2, suffix: '+' },
					{
						label: t('hero.statsSection.completedProjects'),
						value: 17,
						suffix: '+',
					},
					{
						label: t('hero.statsSection.satisfiedClients'),
						value: 95,
						suffix: '%',
					},
				]}

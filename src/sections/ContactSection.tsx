...
import ContactCard from "../components/ContactCard"; // Adjust path if necessary
...
const ContactSection: React.FC = () => {
  return (
    <section
      id="contact"
      className="py-16 md:py-24 bg-bgbrand dark:bg-bgbrand-dark flex flex-col items-center justify-center"
    >

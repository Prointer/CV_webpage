...
import { TimelineItem } from '../types/timeline'; // Adjust path if necessary
...
const experienceData: TimelineItem[] = [
  ...
  },
  {
    ...
    dateStart: 'Jan 2022',
    dateEnd: 'May 2023',
    description: 'Built and maintained client websites using HTML, CSS, JavaScript, and WordPress. Worked directly with clients to gather requirements and provide support.',
...
const educationData: TimelineItem[] = [
  {
    ...
    dateStart: 'Sep 2018',
    dateEnd: 'May 2022',
    description: 'Relevant coursework: Data Structures, Algorithms, Web Development, Database Management. Senior Project: Developed a full-stack web application for event management.',
  ...
  },
  {
    ...
    dateStart: 'Jun 2021',
    dateEnd: 'Dec 2021',
    description: 'Intensive program covering MERN stack (MongoDB, Express, React, Node.js), data structures, and algorithms. Completed several individual and group projects.',
  },
];
...
const certificatesData: TimelineItem[] = [
  {
    ...
    dateStart: 'Completed',
    dateEnd: 'Mar 2021',
    description: 'Covered HTML5, CSS3, Flexbox, CSS Grid, and responsive design principles.',
  ...
  },
  {
    ...
    dateStart: 'Completed',
    dateEnd: 'May 2021',
    description: 'Mastered fundamental JavaScript concepts, data structures like arrays and objects, and algorithmic thinking.',
...
const ExperienceEducation: React.FC = () => {
  return (
    <section id="experience-education" className="py-16 md:py-24 bg-bgbrand dark:bg-bgbrand-dark">
